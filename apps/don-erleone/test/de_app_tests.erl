...
test_get_env_string(_SetupState) ->
    ...
    [begin
         ...
         ?_assertEqual("hello",
                       (de_config:get_env_string(test_str, "default")))
     end,
     begin
         application:set_env(don_erleone, test_bin, <<"world">>),
         ?_assertEqual("world",
                       (de_config:get_env_string(test_bin, "default")))
     end,
...
test_get_env_integer(_SetupState) ->
    [begin
         ...
         ?_assertEqual(42,
                       (de_config:get_env_integer(test_int, 10)))
     end,
     begin
         application:set_env(don_erleone, test_int_str, "100"),
         ?_assertEqual(100,
                       (de_config:get_env_integer(test_int_str, 10)))
     end,
     begin
         application:set_env(don_erleone,
                             test_int_bin,
                             <<"200">>),
         ?_assertEqual(200,
                       (de_config:get_env_integer(test_int_bin, 10)))
     end,
     begin
         application:set_env(don_erleone, test_bad, "not_int"),
         ?_assertEqual(10,
                       (de_config:get_env_integer(test_bad, 10)))
     end,
     ?_assertEqual(10,
                   (de_config:get_env_integer(missing_key, 10)))].
