{
  description = "Haskell MCP Server - Git Service";
  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        haskellPkg = hpkgs.callCabal2nix "git-mcp" ./. { };
      ...
      in
      {
        ...
        apps.default = {
          type = "app";
          program = "${haskellPkgFinal}/bin/git-mcp";
        };
        ...
        devShells.default = pkgs.mkShell {
          ...
          buildInputs = with pkgs.haskellPackages; [
            ...
            # Git Subprocess Binaries (Exposed natively to git-mcp logic)
            pkgs.git
            pkgs.gh
          ];

          shellHook = ''
            echo "--- Git MCP Development Environment ---"
            echo "Compiler: $(ghc --version)"
            echo "Tools available: fourmolu, hlint, just, ghciwatch, git, gh"
          '';
        };
      }
    );
